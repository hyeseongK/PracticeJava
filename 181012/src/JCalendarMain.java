...
class JCalendar{
	...
	public int total(int year) { // total overloading
		int tot = 0;
	...
	//2017 2 -> 2016 1
	public int total(int year, int month) { //total overloading
		int tot = total(year);
	...
	public int total(int year, int month, int date) {	//total overloading
